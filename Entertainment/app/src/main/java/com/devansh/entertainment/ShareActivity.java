...
public class ShareActivity extends AppCompatActivity {
    ...
    private void shareLink()
    {
        ...
        intent.putExtra(Intent.EXTRA_TEXT,"Hey, I just used "+ getString(R.string.app_name) +" app for Android. It provides amazing movies and comedy shows, sports, latest news content to read as well as watch online. Moreover, its useful for old people who watch classical movies/drama as well as for kids who watch cartoons.\nGet it now on https://drive.google.com/drive/folders/105N8dwqkgU5k7c-5Zot9wPn6peLICURV");
    ...
    private void shareApk()
    {
        ...
        File tempFile = new File(getApplicationContext().getExternalFilesDir(null),
                getString(R.string.app_name)+"_" + BuildConfig.VERSION_NAME.replace(' ', '_') + ".apk");
        if (!tempFile.exists()) {
            try {
